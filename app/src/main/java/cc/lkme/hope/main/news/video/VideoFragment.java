...
public class VideoFragment extends BaseListFragment {
    ...
    private AutoClearedValue<VideoRecyclerViewAdapter> adapter;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        VideoRecyclerViewAdapter videoRecyclerViewAdapter = new VideoRecyclerViewAdapter<>(new ArrayList<ListDataEntry>(), binding.get().recyclerView, viewModel);
        adapter = new AutoClearedValue<>(this, videoRecyclerViewAdapter);
